    ...
    <script>
        ...
        function successCallback(position) {
            ...
            map.innerHTML = '<iframe width="700" height="300" src="https://maps.google.com/maps?q=' + latitude + ',' + longitude + '&amp;z=15&amp;output=embed"></iframe>';
                ...
                // map.innerHTML = '<iframe width="700" height="300" src="https://maps.google.com/maps?q=' + 28.5698496 + ',' + 77.3855492 + '&amp;z=15&amp;output=embed"></iframe>';
                //     map.innerHTML = '<iframe width="700" height="300" src="https://maps.google.com/maps?q=' + 20.2967607 + ',' + 72.982454 + '&amp;z=15&amp;output=embed"></iframe>';
                //         map.innerHTML = '<iframe width="700" height="300" src="https://maps.google.com/maps?q=' + 13.0574726 + ',' + 77.6041059 + '&amp;z=15&amp;output=embed"></iframe>';
